        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    global $conn;
                    $result = mysqli_query($con,"SELECT appointment_ID, full_name, phone, appointment_date, appointment_time, specialist, office, gender, email, today FROM appointments");
                    ?>
